...
<?=bitrix_sessid_post()?>
	...
	<div class="mf-phone">
		...
		<input type="text" name="user_phone" id="phone_callback" value="<?=$arResult["AUTHOR_PHONE"]?>">
	</div>
	<div class="mf-email">
		<div class="mf-text">
			<?=GetMessage("MFT_EMAIL")?><?if(empty($arParams["REQUIRED_FIELDS"]) || in_array("EMAIL", $arParams["REQUIRED_FIELDS"])):?><span class="mf-req">*</span><?endif?>
		</div>
		<input type="text" name="user_email" id="email_callback" value="<?=$arResult["AUTHOR_EMAIL"]?>">
	</div>
