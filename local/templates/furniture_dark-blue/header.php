...
<link href="<?=SITE_TEMPLATE_PATH?>/fancybox/jquery.fancybox-1.3.4.css" type="text/css" rel="stylesheet"  media="screen"/>
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.4/jquery.min.js"></script>

<script type="text/javascript" src="<?=CUtil::GetAdditionalFileURL(SITE_TEMPLATE_PATH.'/fancybox/jquery.fancybox-1.3.4.pack.js')?>"></script>
<script type="text/javascript" src="<?=CUtil::GetAdditionalFileURL(SITE_TEMPLATE_PATH.'/fancybox/jquery.mousewheel-3.0.4.pack.js')?>"></script>
