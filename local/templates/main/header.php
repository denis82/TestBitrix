...
<link rel="stylesheet" type="text/css" href="<?=SITE_TEMPLATE_PATH?>/template_style.css"/>
...
<link rel="shortcut" type="image/x-icon" href="<?=SITE_TEMPLATE_PATH?>/favicon.ico">
				...
				<table>
					<tr>
						...
						<td rowspan="2" class="hd_txarea">
							...
							<?=GetMessage('workingTime')?>время работы <span class="workhours">ежедневно с 9-00 до 18-00</span>						
						</td>
